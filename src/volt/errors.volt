...
CompilerException makeExpected(Location location, string s, string file = __FILE__, size_t line = __LINE__)
{
	return new CompilerError(location, format("expected %s.", s), false, file, line);
}
